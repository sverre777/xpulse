...
export async function getWorkoutStats(
  ...
  const { data: rows, error } = await supabase
    ...
    .or('is_completed.eq.true,and(is_planned.eq.false,live_started_at.is.null)')       // kun gjennomførte økter (is_planned kan fortsatt være true)
    .gte('date', fromDate)
    .lte('date', toDate)
    .order('date')
...
export async function getCustomBreakdown(
  ...
  try {
    ...
    else req = req.or('is_completed.eq.true,and(is_planned.eq.false,live_started_at.is.null)')
