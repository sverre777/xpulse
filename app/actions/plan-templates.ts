...
function normalizeActivitiesFromDb(raw: unknown[]): ActivityRow[] {
  ...
  return activities.map(a => {
    ...
    return {
      ...
      shooting_type: (a.is_dry_training === true ? 'torrtrening' : '') as ActivityRow['shooting_type'],
      shooting_is_innskyting: a.activity_type === 'skyting_innskyting',
      shooting_is_test: false,
      shooting_surface: '' as const,
      shooting_test_ref: '',
      shooting_series: [],
