  ...
  return (
    <div style={{ borderBottom: '1px solid #1E1E22' }}>
      <button
        type="button"
        onClick={() => setOpen(o => !o)}
        className="w-full flex items-center justify-between px-4 md:px-6 py-3 transition-colors hover:bg-[#111113]"
      ...
      {open && (
        <div className="px-4 md:px-6 pb-4">
          ...
          {!data && !error && !isPending && (
            <p className="text-xs py-4" style={{ fontFamily: "'Barlow Condensed', sans-serif", color: '#555560' }}>
              Laster…
            </p>
          )}
