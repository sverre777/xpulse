...
export function HeartZonesSection({
  ...
  return (
    <section className="p-6 mt-6" style={{ backgroundColor: 'var(--card2)', border: '1px solid var(--line)', borderRadius: 12 }}>
...
function ZoneCard({
  ...
  return (
    <div className="flex items-center gap-3 p-3"
      style={{ backgroundColor: 'var(--card)', border: '1px solid var(--line)', borderRadius: 14, borderLeft: `3px solid ${color}` }}>
      <span style={{
