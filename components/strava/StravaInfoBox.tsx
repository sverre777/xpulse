  ...
  return (
    <div className="mb-5 p-5"
      ...
      <ul className="space-y-2 mb-4" style={{ fontFamily: "'Barlow Condensed', sans-serif", color: '#F0F0F2', fontSize: '13px', lineHeight: 1.6 }}>
        <li><Ikon navn="fullfort" variant="strek" storrelse={14} /> <strong>Permanent lagring</strong>: varighet, distanse, sport, snittpuls, makspuls, sonefordeling og lap-data så lenge Strava er koblet til.</li>
        <li><Ikon navn="fullfort" variant="strek" storrelse={14} /> All analyse, trender, PR-er og sonefordelinger basert på aggregerte verdier beholdes.</li>
        <li><Ikon navn="fullfort" variant="strek" storrelse={14} /> Strava-data deles aldri med tredjeparter eller brukes til AI-trening.</li>
      </ul>

      <ul className="space-y-2 mb-4" style={{ fontFamily: "'Barlow Condensed', sans-serif", color: '#FFB300', fontSize: '13px', lineHeight: 1.6 }}>
        <li><Ikon navn="advarsel" variant="strek" storrelse={14} /> Rå data (sekund-for-sekund puls, GPS-rute, watts-strøm) slettes etter <strong>7 dager</strong> - Stravas krav.</li>
        <li><Ikon navn="advarsel" variant="strek" storrelse={14} /> Ved frakobling slettes <strong>ALL</strong> Strava-data innen 48 timer (Stravas regler).</li>
      </ul>
      ...
      <div className="p-3"
        ...
        <p style={{ fontFamily: "'Barlow Condensed', sans-serif", color: '#28A86E', fontSize: '13px', lineHeight: 1.6 }}>
          <Ikon navn="tips" variant="strek" storrelse={14} /> <strong>Tips</strong>: Vil du beholde alt permanent? Eksporter .fit-filer manuelt fra
