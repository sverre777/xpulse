...
export function PunktEtiketter({ punkter, synlig, segmentVed, stil = 'etikett' }: {
  punkter: Punkt[]
...
// Bolk 5: KompaktKurve bor i ./KompaktKurve — re-eksport for gamle importer.
export { KompaktKurve } from './KompaktKurve'
